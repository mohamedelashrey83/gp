...
const int wheel_d = 75;           // Wheel diameter (mm)
const float wheel_c = PI * wheel_d; // Wheel circumference (mm)
const int counts_per_rev = 620;   // (4 pairs N-S) * (48:1 gearbox) * (2 falling/rising edges) = 384

// Pins
const int enc_l_pin = 2;          // Motor A
const int enc_r_pin = 18;          // Motor B
const int pwma_pin = 6;
const int ain1_pin = 5;
const int ain2_pin = 4;
const int pwmb_pin = 13;
